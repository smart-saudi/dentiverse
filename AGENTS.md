# DentiVerse — Codex Instructions

> This file is the **single source of truth** for all AI-assisted development.
> Codex reads this automatically at the start of every session.
...
| **Auth**        | Supabase Auth (email/password + password reset for v1 launch) | Roles: DENTIST, LAB, DESIGNER, ADMIN with a shipped `/admin` workspace for active admins |
...
7. **ALWAYS check `AGENTS.md`** (this file) at the start of every session.
...
2. Check this file (`AGENTS.md`) for any updates.
...
| Admin Ops Model      | `docs/phase-5/operations/ADMIN_OPERATING_MODEL.md` | Admin Panel v1 workflows plus fallback support, moderation, and refund procedures |
